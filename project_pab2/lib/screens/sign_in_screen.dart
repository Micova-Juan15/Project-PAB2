...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void _signIn() async {
    ...
    try {
      ...
      // Navigasi ke layar berikutnya setelah berhasil sign in
  ...
  Future<String> _getEmailFromUsername(String username) async {
    // Fungsi ini harus diimplementasikan untuk mendapatkan email berdasarkan username dari Firestore
    // Misalnya, Anda bisa mencari username di koleksi "users" dan mendapatkan email-nya
    // Contoh:
    ...
    throw UnimplementedError('Implement email lookup based on username');
  }
